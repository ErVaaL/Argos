...
- Process service: `LOGGING_LEVEL_COM_ERVAL_ARGOS`, `LOGGING_LEVEL_ORG_SPRINGFRAMEWORK_AMQP`, `LOGGING_LEVEL_ORG_SPRINGFRAMEWORK_AMQP_RABBIT_LISTENER`, `LOGGING_LEVEL_ORG_SPRINGFRAMEWORK_RABBIT`, `LOGGING_LEVEL_ORG_SPRINGFRAMEWORK_MESSAGING`, `LOGGING_LEVEL_ORG_SPRINGFRAMEWORK_AMQP_SUPPORT_CONVERTER`, `SPRING_MONGODB_URI`, `ARGOS_RESOURCE_GRPC_HOST`, `ARGOS_RESOURCE_GRPC_PORT`, `SPRING_RABBITMQ_HOST`, `SPRING_RABBITMQ_PORT`, `SPRING_RABBITMQ_USERNAME`, `SPRING_RABBITMQ_PASSWORD`, `SPRING_SECURITY_OAUTH2_RESOURCESERVER_JWT_ISSUER_URI`
- Report service: `LOGGING_LEVEL_ORG_SPRINGFRAMEWORK_AMQP`, `LOGGING_LEVEL_ORG_SPRINGFRAMEWORK_RABBIT`, `SPRING_MONGODB_URI`, `ARGOS_RESOURCE_GRPC_HOST`, `ARGOS_RESOURCE_GRPC_PORT`, `SPRING_RABBITMQ_HOST`, `SPRING_RABBITMQ_PORT`, `ARGOS_REPORT_STORAGE_DIR`, `SPRING_SECURITY_OAUTH2_RESOURCESERVER_JWT_ISSUER_URI`
